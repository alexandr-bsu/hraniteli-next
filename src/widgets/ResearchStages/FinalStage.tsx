          ...
          {occupation === 'no income' ? (
            ...
            <>
              <div className="border-[#D4D4D4] border-[2px] p-[20px] text-center rounded-[30px] max-lg:text-[14px] mt-[30px] flex justify-center items-center text-[18px] leading-[25px] font-normal w-full">
                <p> знак благодарности мы обещали подарить бесплатную сессию с аналитическим психологом из Хранителей. Сессия - 55 минут, онлайн, по видеосвязи. <span className="font-bold">Первая сессия - бесплатная, вторая и последующие - по цене психолога на карточке.</span> Готовы сейчас оставить запрос и выбрать время?</p>
              </div>
            </>
          )}
        </div>
