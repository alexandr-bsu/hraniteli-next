        ...
        <div className=" flex h-full w-full justify-center items-center flex-col px-[30px] gap-[30px]">
            <div className="grow w-full flex flex-col items-center justify-center">
                ...
                <div className="flex flex-col items-center gap-[10px]">
                    ...
                    <span className="font-normal text-[18px] leading-[25px] text-center max-lg:text-[14px]">Спасибо! Мы получили ваш запрос. Чтобы забронировать время - запустите телеграм-бот
                    {/* <br />  */}
                    </span>
                </div>
