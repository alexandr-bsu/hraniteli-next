...
export const EmergencyContactsClone = ({ onClose }: EmergencyContactsProps) => {
    ...
    return (
        <div className="flex flex-col w-full h-full px-[50px] py-[30px] max-lg:px-[20px] overflow-y-auto">
